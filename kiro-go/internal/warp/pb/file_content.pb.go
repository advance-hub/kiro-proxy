...
const file_file_content_proto_rawDesc = "" +
	...
	"\x03end\x18\x02 \x01(\rR\x03end\"\x8e\x01\n" +
	"\vFileContent\x12\x1b\n" +
	"\tfile_path\x18\x01 \x01(\tR\bfilePath\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\x12H\n" +
	"\n" +
	"line_range\x18\x03 \x01(\v2).warp.multi_agent.v1.FileContentLineRangeR\tlineRange\"D\n" +
	"\x11BinaryFileContent\x12\x1b\n" +
	...
	"\acontentB\x1aZ\x18kiro-go/internal/warp/pbb\x06proto3"
